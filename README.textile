...
The main goal of this exercise is to develop a web application with Ruby on Rails in which we are
going to implement a web system for managing a library.
Through the exercise solving is advisable to use software development good practices, like
version control software (like git or mercurial), code hosting (like github or bitbucket) or TDD
(Test Driven Development, using RSpec).
The students must handle the solution to the laboratory professor and show him the system
working.
Last day to fulfil the lab requirements is May 5th, 2015
Library Web App
We want to develop a Library Management Web Application in Ruby on Rails. This app should
...
o Publications Borrowing and Circulation
o Readers and Users
 The app should have a User Management module, which permits users to access the
system by authenticating themselves and determining user roles:
o Administrator: Can manage users (admins, managers and readers), roles, books
and loans
o Manager: Can manage readers, books and loans
o Reader: Can list its current and past loans, and also can manage a wish list
 Publications:
o Can be borrowed by only one reader if they are physical books
o Can be borrowed by several readers if they are in electronic form
o We should keep a history of loans
